...
* Other TODOs
  ...
  :END:
** Move Startup files and Includes to Snippet folder
   :PROPERTIES:
   :DATE:     <2018-07-30 Mon 08:25>
   :END:
** Execute any file in Snippet folder with shift-return.
   :PROPERTIES:
   :DATE:     <2018-07-30 Mon 08:25>
   :END:
** On server boot: run preloads of curently selected file and remove them from the preload list.
   :PROPERTIES:
   :DATE:     <2018-07-30 Mon 08:25>
   :END:
